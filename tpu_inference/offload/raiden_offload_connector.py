    ...
    def get_finished(self, finished_req_ids: set[str]) -> tuple[set[str], set[str]]:
        ...
        for item in self._pending_saves:
            ...
            try:
                ...
                # [EXPERIMENTAL] Unlock physical blocks immediately after save completes!
                # This makes them evictable in C++ while they remain logically valid in the cache.
                logger.debug(f"Raiden Worker: Save complete for {req_id}. Unlocking {len(chunks)} physical chunks: {chunks}")
